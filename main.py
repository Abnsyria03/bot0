...
if not db.exists("ban_list"):
    db.set("ban_list", [])
x = Client(name='lossclhos', api_id=19312827, api_hash='84da7f08e87849853b2fa6728e4192a2', bot_token='5455927541:AAGg2yoyx-1eaOkFxgYCsqybiFg0LYeP6mU', workers=20, plugins=p, parse_mode=enums.ParseMode.DEFAULT)
alive()
x.run()
